...
@objc public class TSAppState: NSObject {

    private static var _sharedInstance: TSAppState?
    ...
    @objc public class func sharedInstance() -> TSAppState {
        onceLock.lock()
        defer { onceLock.unlock() }
        if _sharedInstance == nil {
            _sharedInstance = TSAppState()
        }
