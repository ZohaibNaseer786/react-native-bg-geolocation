...
@objc public class TSLoggerConfig: TSConfigModuleBase {
    ...
    @objc public override func propertySpecs() -> [TSPropertySpecImpl] {
        return [
            TSPropertySpec(name: "logLevel", type: "int"),
            TSPropertySpec(name: "logMaxDays", type: "int"),
            TSPropertySpec(name: "debug", type: "bool")
        ]
    }
    ...
    @objc public override var description: String {
        return "<TSLoggerConfig logLevel=\(logLevel) logMaxDays=\(logMaxDays) debug=\(debug)>"
    }
}
