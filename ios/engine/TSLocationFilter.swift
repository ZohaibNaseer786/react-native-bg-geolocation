...
@objc public class TSLocationFilterResult: NSObject {
    ...
    @objc public override var description: String {
        return "<TSLocationFilterResult decision=\(decision) reason=\(reason) delta=\(deltaEffective)>"
    }
}

@objc public class TSLocationFilter: NSObject {
    ...
    private var kalman: TSKalmanFilter?
    ...
    @objc public func configure(_ config: TSLocationFilterConfig) {
        applyConfig(config)
    }

    @objc public func applyConfig(_ config: TSLocationFilterConfig) {
    ...
    @objc public func evaluateWithMetrics(_ metrics: TSLocationMetrics) -> TSLocationFilterResult {
        let result = TSLocationFilterResult()
