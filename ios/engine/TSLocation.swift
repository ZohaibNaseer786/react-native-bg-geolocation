...
@objc public class TSLocation: NSObject {
    ...
    @objc public init(location: CLLocation, geofence: TSGeofence) {
        self.location = location
    ...
    @objc public init(location: CLLocation, geofenceEvent: TSGeofenceEvent) {
        self.location = location
    ...
    @objc public func isValidCoordinate(_ coord: CLLocationCoordinate2D) -> Bool {
        return TSLocation.isValidCoordinate(coord)
    }
    ...
    @objc public func renderTemplate(_ template: TSTemplate, error: UnsafeMutablePointer<NSError?>?) -> String? {
    ...
    @objc public func handleTemplateError(_ error: Error, template: TSTemplate) {
    }

    @objc public func selectTemplate() -> TSTemplate? {
        return nil
    }

    @objc public func templateName(forTemplate template: TSTemplate) -> String {
    ...
    @objc public func errorWithCode(_ code: Int, description: String) -> NSError {
        return NSError(domain: "TSLocation", code: code, userInfo: [NSLocalizedDescriptionKey: description])
    }
