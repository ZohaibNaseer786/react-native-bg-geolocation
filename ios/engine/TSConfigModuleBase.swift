...
@objc public class TSPropertySpecImpl: NSObject {
...
public func TSPropertySpec(name: String, type: String) -> TSPropertySpecImpl {
    return TSPropertySpecImpl(name: name, type: type)
}

@objc public class TSConfigModuleBase: NSObject {
    ...
    @objc public func propertySpecs() -> [TSPropertySpecImpl] { return [] }
