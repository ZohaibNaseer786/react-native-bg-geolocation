...
@objc public class TSLocationMetrics: NSObject {
...
@objc public class TSLocationMetricsEngine: NSObject {

    @objc public var config: TSLocationFilterConfig?
    ...
    @objc public init(withConfig config: TSLocationFilterConfig) {
        self.config = config
        super.init()
        applyConfig(config)
    }
    ...
    @objc public func computeStationaryMetrics(_ metrics: TSLocationMetrics, current: CLLocation) {
    ...
    @objc public override var description: String {
        return "<TSLocationMetricsEngine rollingWindow=\(rollingWindow)>"
    }
}
